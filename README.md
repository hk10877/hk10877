...
- **Tech Stack:** PyTorch, Rust, FastF1, WebSockets, React
- **Learnings:** Designed an end-to-end real-time ML system, from telemetry ingestion and model inference to low-latency backend–frontend integration
